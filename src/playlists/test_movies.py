...
from src.playlists.models import MovieProxy
...
class MovieProxyTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.movie_a_2 = MovieProxy.objects.create(title=self.movie_title, video=self.video_a)
    ...
    def test_movie_slug_unique(self):
        self.assertNotEqual(self.movie_a.slug, self.movie_a_2.slug)
